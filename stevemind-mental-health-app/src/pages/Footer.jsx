...
=======
      <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 ml-2"><FontAwesomeIcon icon={faFacebook} size="lg" className="mr-2" /></a>
      <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 ml-2"><FontAwesomeIcon icon={faInstagram} size="lg" className="mr-2" /></a>
      <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="text-blue-400 ml-2"><FontAwesomeIcon icon={faTiktok} size="lg" className="mr-2" /></a>
>>>>>>> backup-branch
    </footer>
  );
}
